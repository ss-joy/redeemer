/*
  ...
  - Added the required column `shop_name` to the `new_customers` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_new_customers" ("customer_id", "id", "new_customer_data_recorder_at") SELECT "customer_id", "id", "new_customer_data_recorder_at" FROM "new_customers";
