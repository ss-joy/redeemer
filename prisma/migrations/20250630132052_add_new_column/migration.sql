...
INSERT INTO "new_reward_points_transaction_history" ("created_at", "customer_id", "id", "rule_type", "shop_id", "total_transacted_points") SELECT "created_at", "customer_id", "id", "rule_type", "shop_id", "total_transacted_points" FROM "reward_points_transaction_history";
