...
INSERT INTO "new_Coupons" ("coupon_code", "coupon_id", "created_at", "customer_id", "id", "shop_id", "updated_at") SELECT "coupon_code", "coupon_id", "created_at", "customer_id", "id", "shop_id", "updated_at" FROM "Coupons";
DROP TABLE "Coupons";
